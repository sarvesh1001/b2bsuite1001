...
import { createFine } from '@b2b/api-client';
import {
  BACKGROUND_COLOR,
  CARD_BACKGROUND,
  PRIMARY_COLOR,
...
type NavigationProps = StackNavigationProp<RootStackParamList, 'CreateFine'>;

export default function CreateFineForm() {
  ...
  const handleSubmit = async () => {
    ...
    setLoading(true);
    try {
      await createFine(companyId, deviceId, accessToken, {
        user_id: userId.trim(),
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Create Fine</Text>
        <View style={{ width: 24 }} />
      </View>
      ...
      <ScrollView contentContainerStyle={styles.formContainer}>
        ...
        <TouchableOpacity
          ...
          disabled={loading}
        >
          {loading ? <ActivityIndicator size="small" color="#fff" /> : <Text style={styles.submitText}>Create Fine</Text>}
        </TouchableOpacity>
      </ScrollView>
