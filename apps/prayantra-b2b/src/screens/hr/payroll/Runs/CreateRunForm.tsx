...
import { createRun } from '@b2b/api-client';
import {
  BACKGROUND_COLOR,
  CARD_BACKGROUND,
  PRIMARY_COLOR,
...
type NavigationProps = StackNavigationProp<RootStackParamList, 'CreateRun'>;
...
export default function CreateRunForm() {
  ...
  const handleSubmit = async () => {
    ...
    setLoading(true);
    try {
      await createRun(companyId, deviceId, accessToken, {
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Create Payroll Run</Text>
        <View style={{ width: 24 }} />
      </View>
      ...
      <ScrollView contentContainerStyle={styles.formContainer}>
        ...
        <TouchableOpacity
          ...
          disabled={loading}
        >
          {loading ? <ActivityIndicator size="small" color="#fff" /> : <Text style={styles.submitText}>Create Run</Text>}
        </TouchableOpacity>
      </ScrollView>
