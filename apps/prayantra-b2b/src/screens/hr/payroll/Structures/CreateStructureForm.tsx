...
import { createStructure } from '@b2b/api-client';
import {
  BACKGROUND_COLOR,
  CARD_BACKGROUND,
  PRIMARY_COLOR,
...
type NavigationProps = StackNavigationProp<RootStackParamList, 'CreateStructure'>;

export default function CreateStructureForm() {
  ...
  const handleSubmit = async () => {
    ...
    setLoading(true);
    try {
      await createStructure(companyId, deviceId, accessToken, {
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Create Structure</Text>
        <View style={{ width: 24 }} />
      </View>
      ...
      <ScrollView contentContainerStyle={styles.formContainer}>
        ...
        >
          {loading ? (
            ...
            <Text style={styles.submitText}>Create Structure</Text>
          )}
        </TouchableOpacity>
      </ScrollView>
    </SafeAreaView>
